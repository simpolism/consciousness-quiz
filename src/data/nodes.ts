...
const endDetails: Partial<Record<NodeId, string>> = {
  ...
  illusionism: `Illusionists reinterpret talk of qualia as shorthand for cognitive accessibility, narrative coherence, and control. This approach emphasizes explanatory payoffs—deflating hard problems, aligning with predictive coding—while acknowledging the existential shock of calling experience a construct.`,
  ...
  iit: `IIT explains how integrated cause–effect power supposedly yields a single point of view. Supporters highlight empirical measures (like perturbational complexity index) and a principled taxonomy of experience, even while critics debate testability and panpsychist implications.`,
  gwt: `Global Workspace Theory maps consciousness onto a system-wide broadcasting hub coordinating perception, memory, and action. Supporting evidence includes ignition events, P3 waves, and masked priming while conceding debates about unconscious cognition.`,
  pp: `Predictive processing pictures brains as hierarchies minimizing surprise. This framework explains how precision weighting, generative models, and active inference might produce the distinctive feel of experience, while skeptics question whether prediction alone can do the job.`,
  hot: `Higher-order theories require thoughts about thoughts: a state becomes conscious when we represent ourselves as having it. This mechanism secures reportability and self-reflection, yet raises worries about animals, infants, and misrepresentations.`,
  rpt: `Recurrent processing theorists pinpoint local cortical feedback loops as the minimal neural correlate. Evidence comes from masking paradigms and laminar recordings, along with the open question of whether deeper loops into frontal areas are needed.`,
  ast: `Attention Schema Theory treats consciousness as a control model—an internal sketch that helps guide attention. Simplified schemas aid prediction of others' focus and lesions or artificial agents might instantiate similar control circuits.`,
  enactive: `Embodied/enactive views see mind as enacted through sensorimotor skills and environmental coupling. Key considerations include phenomenology of action, dynamical systems evidence, and critiques of disembodied AI, while noting challenges such as dreaming or locked-in states.`,
  panpsych: `Panpsychism posits experiential dust everywhere, solving the combination problem by degrees rather than leaps. Key arguments include intrinsic natures and continuity, alongside objections about how micro-experiences combine coherently.`,
  neutral_monism: `Russellian monism assigns matter hidden qualitative aspects that ground consciousness without invoking dual substances. This represents a middle path between pure physicalism and panpsychism, while flagging debates about empirical access to such qualities.`,
  dual_aspect: `Dual-aspect theory holds that one underlying reality yields mental and physical descriptions depending on perspective. This connects to Spinoza, neutral monism, and modern information-based proposals, noting its appeal for unifying science and subjectivity.`,
  ideal: `Idealism and cosmopsychism claim reality is fundamentally mental, with individual minds as partitions of a cosmic consciousness. Motivations include unity, measurement problems, and phenomenology, as well as the burden of explaining apparent physical objectivity.`,
  dualism: `Substance dualism posits two kinds of stuff: immaterial mind and material body. This view addresses interaction debates, neuroscientific correlations, and why some hold souls indispensable for agency or moral status.`,
  property_dualism: `Property dualists accept one substance but insist on irreducible mental qualities layered atop physics. Key arguments include knowledge/qualia arguments, zombie conceivability, and efforts to keep causal efficacy without adding new substances.`,
  epiphenomenalism: `Epiphenomenalists maintain experience is real yet causally impotent, riding shotgun on physical processes. This raises puzzles about free will, evolution, and why we talk about feelings if they never act, despite motivations from knowledge arguments.`,
  representationalism: `Representationalism says phenomenal character supervenes on representational content. This involves transparency theses, tracking vs. structural representational accounts, and challenges from inverted spectra or nonrepresentational moods.`,
  access_phenomenal: `The access/phenomenal distinction keeps separate what information a system can use and what it feels like. This includes Block's empirical thought experiments, global workspace tensions, and how the distinction influences AI consciousness debates.`,
  phenom: `Phenomenology prioritizes lived first-person structure as primary data. This approach connects Husserlian bracketing, Nagel's bat argument, and contemporary analytic phenomenology that resists reductive moves in favor of describing experience on its own terms.`,
  functionalist: `Functionalists judge consciousness by roles played—if a system processes information like we do, it counts. Supporting evidence includes thought experiments (China Brain, silicon chips), cognitive science research, and criticisms about missing qualia or absent feelings.`,
  biological_functionalism: `Biological functionalism keeps functional roles but insists on biologically grounded realizers. This raises neural chauvinism worries, distinctions between weak and strong realization, and why some neuroscientists stress living substrates.`,
  emergent_physicalism: `Emergent physicalists think novel mental properties arise at high complexity, exercising top-down influence. This draws on historical roots in Broad and Sperry plus modern systems theories, while acknowledging the challenge of formalizing emergence.`,
  recognition: `Recognition-based theories tie self-awareness to social mirroring and intersubjective validation. Key considerations include developmental milestones, phenomenological accounts of the gaze, and critiques about solitary or pre-social consciousness.`,
  information_closure: `Information-closure theories generalize the idea that closed informational loops generate an internal point of view. This includes proposals from Tegmark and Fields while noting difficulties in measuring closure empirically.`,
  eliminativism: `Eliminativists predict folk psychology will be replaced by mature neuroscience that lacks qualia talk. Arguments include theory change, parallels with phlogiston, and objections about losing first-person data.`,
  noself: `No-self theorists such as Buddhists and Metzinger see the subject as a useful fiction created by self-models. Supporting evidence includes meditation research, neuroscientific correlates (TPJ, DMN), and ethical implications of deconstructing the ego.`,
  bio_only: `Biological naturalists require living brains, emphasizing metabolism, homeostasis, and evolutionary embedding. This view explains why silicon or disembodied software falls short, while acknowledging debates about brain organoids and uploads.`,
  localist: `Neurobiological localists identify specific hubs—claustrum, thalamus—as consciousness bottlenecks. Supporting evidence includes clinical data from lesions and stimulation, and questions about redundancy or plasticity undermining strict localization.`,
  embodied_restriction: `Embodiment restrictions prioritize lived bodies, sensorimotor contingencies, and affective regulation. Key evidence includes enactivist critiques of desktop AI and rehabilitation cases showing how bodily disruption alters experience.`,
  info_processing_restriction: `Information-processing restrictionists argue only certain architectural features (depth, global buffers, rich world models) produce experience. This approach considers classical vs. connectionist systems and whether architecture can substitute for biology.`,
  quantum: `Orch-OR supporters invoke non-computable quantum collapses to ground consciousness. Key elements include Penrose's Gödelian motivations, Hameroff's microtubule research, and scientific criticisms regarding decoherence and testability.`,
  dualist_exclusion: `Dualist exclusionists reserve consciousness for ensouled beings, often informed by religious doctrine. This view addresses how to handle AI, animals, and moral status, while acknowledging difficulty in verifying souls empirically.`,
  behaviorist: `Behaviorist restrictionism withholds consciousness attribution without robust behavioural flexibility. This approach draws on Skinnerian pragmatism, Turing-style tests, and critiques that behavior alone may be gamed or insufficient.`,
  restrictive_phys: `Restrictive physicalism limits consciousness to specific physical organizations even if other substrates mimic behavior. This view draws on identity-theory motivations, neural correlates research, and challenges from hypothetical silicon brains.`,
};
